...
import { byteToString, intArrayToHex } from './utils';
...
export default class BleModule {
  ...
  /** 断开蓝牙连接 */
  disconnect() {
    console.log('disconnect this.peripheralId=', this.peripheralId);
  ...
  startNotification(index = 0): Promise<void> {
    console.log('startNotification', index, this.peripheralId, this.nofityServiceUUID[index], this.nofityCharacteristicUUID[index]);
    return new Promise((resolve, reject) => {
  ...
  startNotificationByUuid(s_uuid: string, n_uuid: string): Promise<void> {
    console.log('startNotification', this.peripheralId, n_uuid);
    return new Promise((resolve, reject) => {
      BleManager.startNotification(
        this.peripheralId,
        s_uuid,
  ...
  write(data: any, index = 0): Promise<void> {
    console.log('write', index, this.peripheralId, this.writeWithResponseServiceUUID[index], this.writeWithResponseCharacteristicUUID[index]);
    return new Promise((resolve, reject) => {
      BleManager.write(
        this.peripheralId,
  ...
  writeByUuid(data: any, s_uuid: string, w_uuid: string): Promise<void> {
    console.log('write', s_uuid, w_uuid);
    return new Promise((resolve, reject) => {
      BleManager.write(
        this.peripheralId,
        s_uuid,
  ...
  readByUuid(s_uuid: string, r_uuid: string): Promise<string> {
    return new Promise((resolve, reject) => {
      BleManager.read(
        this.peripheralId,
        s_uuid,
